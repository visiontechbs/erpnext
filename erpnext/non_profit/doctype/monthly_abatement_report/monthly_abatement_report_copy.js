					...
					callback: function (data) {
						if (data.message) {
							...
							$.each(data.message, function (i, d) {
								...
								memeber_id = d[0];
								// child.payroll_number = d[10];
								if (frm.doc.subscription_1 == d[3]) {
								...
								if (frm.doc.subscription_6 == d[3]) {
									child.subscription_6 = d[4];
									//separat credit_acount by "~" into a string
									if (child.credit_account_list == undefined) {
										child.credit_account_list = d[8];
									}
								...
								if (frm.doc.subscription_7 == d[3]) {
									child.subscription_7 = d[4];
									//separat credit_acount by "~" into a string
									if (child.credit_account_list == undefined) {
										child.credit_account_list = d[8];
									}
